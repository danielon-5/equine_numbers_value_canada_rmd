...
```{r plot horses, fig.width=10, fig.height=3, fig.cap="Figure 1. Horse populations for all provinces in Canada from 1940 - 1972.", out.width="100%"}
...
```{r plot province, fig.width=5, fig.height=4, fig.cap="Figure 2. Number of horses for province in focus", out.width="50%"}
